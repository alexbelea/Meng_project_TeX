...
There were several iterations, at first with only the Transimpedance Amplificer Circuit (TIA) - a design that when tested, resulted in a low Voltage output when testing with only the LED light from the \ac{RED} testbench. 
