...
The \texttt{Config} class (Listing~\ref{lst:pythonConfigClass}) loads and parses the configuration file, making parameters accessible throughout the application:
\begin{lstlisting}[style=pythonstyle, caption=Model configuration - Config Class, label=lst:pythonConfigClass, language=Python ]
