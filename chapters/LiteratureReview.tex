...
% With an external references.bib file, you don't need the bibliography 
% environment here. Instead, you'll add commands like these to your 
% main LaTeX document where you want the bibliography to appear:
%
% \bibliographystyle{ieeetr}  % or another appropriate style
% \bibliography{references}    % references.bib is your BibTeX file
%
% Make sure your references.bib file contains entries for all the references
% cited in this document with the correct citation keys.