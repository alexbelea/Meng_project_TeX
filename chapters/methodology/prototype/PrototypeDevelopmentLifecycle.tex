...
The black electrical tape was then placed on top of this glas as seen in Figure \ref{fig:StripboardPhoto}. As can be seen the apertures are not fully straight. This is because they were placed by hand. 
% aperture photo
%
\begin{figure}[htbp] %h-ere t-op b-ottom p-page (separte) -good to allow all htbp to give the compiler more options
  \centering
